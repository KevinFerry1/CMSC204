...
public class MyQueueTest {
	...
	public Double double1 = 5.0, double2 = 3.0, double3 = 2.0, double4 = 1.0, double5 = 8.0, double6 = 9.0;
	...
	public void setUp() throws Exception {
		...
		doubleQ.enqueue(double1);
		doubleQ.enqueue(double2);
		doubleQ.enqueue(double3);
		stringQ.enqueue(a);
		stringQ.enqueue(b);
		stringQ.enqueue(c);
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(double1, doubleQ.dequeue());
			assertEquals(double2, doubleQ.dequeue());
			assertEquals(double3, doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(double4));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(double5));
			assertEquals(5, doubleQ.size());
			//Queue is full, next statement should cause QueueOverFlowException
			doubleQ.enqueue(double6);
			assertTrue("This should have caused an QueueOverflowException", false);
		}
		catch (QueueOverflowException e){
			assertTrue("This should have caused an QueueOverflowException", true);
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		assertEquals("5.03.02.0", doubleQ.toString());
	}
